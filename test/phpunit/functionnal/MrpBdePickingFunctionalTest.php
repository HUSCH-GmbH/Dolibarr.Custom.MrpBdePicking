...
/**
 * \file    test/phpunit/MrpBdePickingFunctionalTest.php
...
/**
 * Class MrpBdePickingFunctionalTest
 *
 ...
 *
 * @package Testmrpbdepicking
 */
class MrpBdePickingFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modMrpBdePicking')->click();
		} else {
			// Disable the module
			$this->byHref('modMrpBdePicking')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/mrpbdepicking/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('mrpbdepicking/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/mrpbdepicking/admin/about.php');
		$this->authenticate();
		return $this->assertContains('mrpbdepicking/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('mrpbdepickingwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modMrpBdePicking_MrpBdePickingTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modMrpBdePicking_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
